...
const AddItem = () => {
  ...
  return (
    <div className="background-image h-screen w-screen content-center">
      <div className="max-w-md mx-auto shadow-md opacity-80    bg-blue-300 rounded-lg p-6">
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="border border-blue-700 rounded bg-inherit  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              required
            ></textarea>
          </div>
          <div className="mb-4">
